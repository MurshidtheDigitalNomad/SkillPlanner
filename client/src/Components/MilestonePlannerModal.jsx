...
const MilestonePlannerModal = ({ onClose }) => {
    const initialMilestone = { name: '', deadline: '', task: '', notes: '' };
                    ...
                    {milestones.map((milestone, idx) => (
                        <div key={idx} className="w-full mb-8 last:mb-0">
                            ...
                            <form className="w-full flex flex-col gap-4">
                                ...
                                <div>
                                    <label className="block text-xs font-poppins font-semibold mb-1">Tasks (Seperate each task by a comma)</label>
                                    <textarea
